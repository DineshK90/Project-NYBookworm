      ...
      <div className="my-3">
        ...
        { !this.props.NYTitle ? '' :   
          <div className="my-5 text-center">
            ...
            <p>{ this.props.loggedInUser ? <button className="btn btn-primary mx-2" onClick={()=>this.props.addNYToBooklist()}>Add</button> : ''}
            <button className="btn btn-primary mx-2" onClick={()=>this.props.clearBookDetails()}>Clear</button></p>
          </div>
        }
      </div>
    )
